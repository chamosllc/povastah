...
#declare UseCaseDiagram_77u48e854451c4ee75ae849d72474c5eb8f = union {
  object { Actor rotate -x*90 scale 24.0 translate <91.333, -109.714, 0.0> }
    object { Circle_Text( LabelFont, "アクター",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate <91.333, -109.714, 30.0> }
  ...
  } scale 64  translate <274.000, -110.000, 0.0>}
  ...
  } scale 64  translate <326.667, -193.988, 0.0>}
  ...
  } scale 64  translate <311.000, -308.167, 0.0>}
}
