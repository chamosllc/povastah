...
#declare ActivityDiagram_uky48e854451c4ee75ae849d72474c5eb8f = union {
  ...
  object { ActivityFinal rotate -x*90 scale 24.0 translate <87.004, -220.000, 0.000> }
    ...
    sphere_sweep { linear_spline, 2, <87.004, -44.667, 4.000>, 3.0 <87.004, -131.547, 4.000>, 3.0 material { ControlFlow_ObjectFlowMaterial }}
    sphere_sweep { linear_spline, 2, <87.004, -131.547, 4.000>, 3.0 <87.004, -220.000, 4.000>, 3.0 material { ControlFlow_ObjectFlowMaterial }}
}
#declare ActivityDiagram_o9o48e854451c4ee75ae849d72474c5eb8f = union {
  object { InitialNode rotate -x*90 scale 24.0 translate <120.667, -87.448, 0.000> }
    object { Circle_Text( LabelFont, "InitialNode",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <120.667, -87.448, 30.000> }
  object { Action rotate -x*90 scale 24.0 translate <233.004, -87.448, 0.000> }
    object { Circle_Text( LabelFont, "Action",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <233.004, -87.448, 30.000> }
  ...
  object { ActivityFinal rotate -x*90 scale 24.0 translate <659.350, -303.255, 0.000> }
    object { Circle_Text( LabelFont, "ActivityFinal",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <659.350, -303.255, 30.000> }
  ...
  object { ObjectNode rotate -x*90 scale 24.0 translate <409.080, -303.255, 0.000> }
    object { Circle_Text( LabelFont, "ObjectNode:Class",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <409.080, -303.255, 30.000> }
  ...
  object { DecisionNodeMergeNode rotate -x*90 scale 24.0 translate <345.000, -87.448, 0.000> }
    object { Circle_Text( LabelFont, "DecisionNodeMergeNode",  0.967, 0, 2, 1.633, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <345.000, -87.448, 30.000> }
  object { ForkNode rotate -x*90 scale 24.0 translate <566.333, -87.448, 0.000> }
    object { Circle_Text( LabelFont, "ForkNode",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <566.333, -87.448, 30.000> }
  object { JoinNode rotate -x*90 scale 24.0 translate <674.333, -87.448, 0.000> }
    object { Circle_Text( LabelFont, "JoinNode",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <674.333, -87.448, 30.000> }
  ...
  object { Connector rotate -x*90 scale 24.0 translate <450.781, -94.995, 0.000> }
    object { Circle_Text( LabelFont, "Connector",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <450.781, -94.995, 30.000> }
}
object { ActivityDiagram_o9o48e854451c4ee75ae849d72474c5eb8f }
#declare EYE = <418.667, -435.234, -565.900>;
#declare FOCUS = <418.667, -195.234, 0.000>;
