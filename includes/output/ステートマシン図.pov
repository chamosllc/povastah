...
#declare StateMachineDiagram_98248e854451c4ee75ae849d72474c5eb8f = union {
  ...
  difference { object { StateInternal scale<413.67, 180.09, 16.00> translate <297.83, -256.62, 0.00> }
    object { StateInternal scale<217.23, 171.09, 12.00> translate <205.33, -256.62, -6.00> }
    object { StateInternal scale<175.75, 171.09, 12.00> translate <412.17, -256.62, -6.00> }
  }
    text { ttf LabelFont, "StateInternal", 1, 0 scale <16, 16, 2> texture { LabelTecture } translate <103.00, -182.57, -0.01> }
  object { State rotate -x*90 scale 24.0 translate <205.50, -224.71, 0.00> }
    object { Circle_Text( LabelFont, "State", 1.0, 0, 2, 1.6, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <205.50, -224.71, 30.00> }
  ...
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <140.67, -224.67, 0.00> }
    object { Circle_Text( LabelFont, " ", 1.0, 0, 2, 1.6, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <140.67, -224.67, 30.00> }
  object { FinalState rotate -x*90 scale 24.0 translate <260.67, -276.67, 0.00> }
    object { Circle_Text( LabelFont, " ", 1.0, 0, 2, 1.6, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <260.67, -276.67, 30.00> }
  ...
  object { JunctionPseudostate rotate -x*90 scale 24.0 translate <364.83, -225.50, 0.00> }
    object { Circle_Text( LabelFont, "JunctionPseudostate", 1.0, 0, 2, 1.6, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <364.83, -225.50, 30.00> }
  object { ShallowHistoryPseudostate rotate -x*90 scale 24.0 translate <166.00, -296.00, 0.00> }
    object { Circle_Text( LabelFont, "ShallowHistoryPseudostate", 0.8333333333333334, 0, 2, 1.7666666666666668, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <166.00, -296.00, 30.00> }
  object { DeepHistoryPseudostate rotate -x*90 scale 24.0 translate <434.00, -304.00, 0.00> }
    object { Circle_Text( LabelFont, "DeepHistoryPseudostate", 0.9333333333333333, 0, 2, 1.6666666666666667, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <434.00, -304.00, 30.00> }
  object { State rotate -x*90 scale 24.0 translate <434.15, -225.38, 0.00> }
    object { Circle_Text( LabelFont, "State", 1.0, 0, 2, 1.6, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <434.15, -225.38, 30.00> }
    sphere_sweep { linear_spline, 2, <140.67, -224.67, 4.00>, 3.0 <205.50, -224.71, 4.00>, 3.0 texture { TransitionTexture }}
    sphere_sweep { linear_spline, 2, <205.50, -224.71, 4.00>, 3.0 <260.67, -276.67, 4.00>, 3.0 texture { TransitionTexture }}
    sphere_sweep { linear_spline, 2, <205.50, -224.71, 4.00>, 3.0 <364.83, -225.50, 4.00>, 3.0 texture { TransitionTexture }}
    sphere_sweep { linear_spline, 2, <364.83, -225.50, 4.00>, 3.0 <434.15, -225.38, 4.00>, 3.0 texture { TransitionTexture }}
    sphere_sweep { linear_spline, 2, <166.00, -296.00, 4.00>, 3.0 <205.50, -224.71, 4.00>, 3.0 texture { TransitionTexture }}
    sphere_sweep { linear_spline, 2, <434.00, -304.00, 4.00>, 3.0 <434.15, -225.38, 4.00>, 3.0 texture { TransitionTexture }}
}
object { StateMachineDiagram_98248e854451c4ee75ae849d72474c5eb8f }
#declare EYE = <404.67, -445.67, -562.33>;
#declare FOCUS = <404.67, -205.67, 0.00>;
