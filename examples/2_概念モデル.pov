...
object { Class rotate -x*90 scale 24  translate <-174.31, -9.47, 0.00> }
 text { ttf LabelFont, "物", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture }
 translate <-181.33, -45.47, 30.00> }
}
object { ClassDiagram_oow_6174cfd7c659288bc9badb700978b1e1 }
#declare EYE = <-174.33, -9.33, -256.00>;
#declare FOCUS = <-174.33, -9.33, 0.00>;
