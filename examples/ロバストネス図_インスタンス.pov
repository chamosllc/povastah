...
#declare ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a = union {
  object { Class rotate -x*90 scale 24.0 translate <179.917, -265.391, 0.0> }
  ...
  object { Class rotate -x*90 scale 24.0 translate <61.333, -182.307, 0.0> }
  ...
  object { Class rotate -x*90 scale 24.0 translate <350.357, -265.307, 0.0> }
  ...
  object { InstanceSpecification rotate -x*90 scale 24.0 translate <61.442, -377.307, 0.0> }
  ...
  object { InstanceSpecification rotate -x*90 scale 24.0 translate <180.109, -446.641, 0.0> }
  ...
  object { InstanceSpecification rotate -x*90 scale 24.0 translate <350.109, -446.641, 0.0> }
