...
#declare ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a = union {
  ...
  text { ttf LabelFont, "EntityController", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture } translate <25.33, -218.31, 30.00> }
  object { Entity rotate -x*90 scale 24.0 translate <350.36, -265.31, 0.00> }
  text { ttf LabelFont, "Entity", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture } translate <354.36, -301.31, 30.00> }
  object { ControlInstance rotate -x*90 scale 24.0 translate <61.44, -377.31, 0.00> }
  text { ttf LabelFont, ":EntityController", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture } translate <21.44, -413.31, 30.00> }
  object { BoundaryInstance rotate -x*90 scale 24.0 translate <180.11, -446.64, 0.00> }
  text { ttf LabelFont, ":EntityRepository", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture } translate <130.11, -482.64, 30.00> }
  object { EntityInstance rotate -x*90 scale 24.0 translate <350.11, -446.64, 0.00> }
  text { ttf LabelFont, ":Entity", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture } translate <350.11, -482.64, 30.00> }
...
#declare EYE = <186.23, -314.49, -532.71>;
