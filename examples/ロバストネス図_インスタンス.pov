...
#declare ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a = union {
  object { Boundary rotate -x*90 scale 24.0 translate <179.917, -265.391, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <179.917, -265.391, 4.0>, LRd <350.357, -265.307, 4.0>, 0.0 material { ShadowAssociationMaterial } no_image }
    }
  object { Control rotate -x*90 scale 24.0 translate <61.333, -182.307, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <61.333, -182.307, 4.0>, LRd <179.917, -265.391, 4.0>, 0.0 material { ShadowAssociationMaterial } no_image }
    }
