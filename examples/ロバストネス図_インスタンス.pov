...
#declare ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a = union {
  ...
  object { ControlInstance rotate -x*90 scale 24.0 translate <61.442, -377.307, 0.000> }
    object { Circle_Text( LabelFont, ":EntityController",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate <61.442, -377.307, 30.000> }
  object { BoundaryInstance rotate -x*90 scale 24.0 translate <180.109, -446.641, 0.000> }
    object { Circle_Text( LabelFont, ":EntityRepository",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate <180.109, -446.641, 30.000> }
  object { EntityInstance rotate -x*90 scale 24.0 translate <350.109, -446.641, 0.000> }
    object { Circle_Text( LabelFont, ":Entity",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate <350.109, -446.641, 30.000> }
    ...
    sphere_sweep { linear_spline, 2, <61.442, -377.307, 4.000>, LRd <180.109, -446.641, 4.000>, LRd material { LinkMaterial }}
    sphere_sweep { linear_spline, 2, <180.109, -446.641, 4.000>, LRd <350.109, -446.641, 4.000>, LRd material { LinkMaterial }}
}
