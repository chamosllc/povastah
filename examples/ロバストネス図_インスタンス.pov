...
#declare ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a = union {
  ...
  object { EntityInstance rotate -x*90 scale 24.0 translate <350.109, -446.641, 0.000> }
    ...
    sphere_sweep { linear_spline, 2, <61.442, -377.307, 4.000>, 3.0 <180.109, -446.641, 4.000>, 3.0 material { LinkMaterial }}
    sphere_sweep { linear_spline, 2, <180.109, -446.641, 4.000>, 3.0 <350.109, -446.641, 4.000>, 3.0 material { LinkMaterial }}
}
