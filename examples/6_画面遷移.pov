...
object { State rotate -x*90 scale 24.0 translate <280.50, -126.26, 0.00> }
 text { ttf LabelFont, "管理者操作", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture }
 translate <242.83, -162.26, 30.00> }
object { SubmachineState rotate -x*90 scale 24.0 translate <511.83, -126.26, 0.00> }
 text { ttf LabelFont, "Entity", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture }
 translate <474.33, -162.26, 30.00> }
object { StateMachineDiagram_bffk_e8128ac6c1d56428bfcbc5567f70b355 scale 0.2026969178082192 translate <452.30800513698625, -111.68524142051942, -8.23> }
// link Transition:[entity]
sphere_sweep { linear_spline, 2, 
<280.50, -126.26, 4.00>, 3.0
<511.83, -126.26, 4.00>, 3.0
  texture { TransitionTexture }}
...
#declare EYE = <366.11, -126.17, -524.28>;
#declare FOCUS = <366.11, -126.17, 0.00>;
