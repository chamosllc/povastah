...
// hierachy depth: {CrudRepository=3, PagingAndSortingRepository=4, Repository=5, EntityRepository=1, JpaRepository=2}
// #declare Depth = -32.0;
...
#declare EYE = <298, -300, -588>;
#declare FOCUS = <298, -40, 0>;
