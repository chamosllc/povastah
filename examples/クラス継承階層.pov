...
// hierachy depth: {CrudRepository=3, EntityRepository=1, JpaRepository=2, Repository=5, PagingAndSortingRepository=4}
// #declare Depth = -32.0;
...
#declare ClassDiagram_1muq6174cfd7c659288bc9badb700978b1e1 = union {
  ...
  object { Boundary rotate -x*90 scale 24.0 translate <221.484, -86.654, -96.000> }
    ...
    sphere_sweep { linear_spline, 2, <221.484, -257.818, -28.000>, 3.0 <477.622, -257.818, 4.000>, 3.0 material { AssociationMaterial }}
    sphere_sweep { linear_spline, 2, <221.484, 1.346, -124.000>, 3.0 <221.484, 86.680, -156.000>, 3.0 material { GeneralizationMaterial }}
    sphere_sweep { linear_spline, 2, <221.484, -86.654, -92.000>, 3.0 <221.484, 1.346, -124.000>, 3.0 material { GeneralizationMaterial }}
    sphere_sweep { linear_spline, 2, <221.484, -174.266, -60.000>, 3.0 <221.484, -86.654, -92.000>, 3.0 material { GeneralizationMaterial }}
    sphere_sweep { linear_spline, 2, <221.484, -257.818, -28.000>, 3.0 <221.484, -174.266, -60.000>, 3.0 material { GeneralizationMaterial }}
}
