...
object { Actor rotate -x*90 scale 24  translate <89.33, -243.54, 0.00> }
 text { ttf LabelFont, "アクター", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture }
 translate <65.33, -279.54, 30.00> }
