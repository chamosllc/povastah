...
object { Actor rotate -x*90 scale 24  translate <106.67, -270.15, 0.00> }
 text { ttf LabelFont, "webアプリユーザ", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture }
 translate <61.67, -306.15, 30.00> }
object { Boundary rotate -x*90 scale 24  translate <257.33, -269.98, 0.00> }
 text { ttf LabelFont, "サーブレット", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture }
 translate <221.33, -305.98, 30.00> }
object { Boundary rotate -x*90 scale 24  translate <546.67, -381.98, 0.00> }
 text { ttf LabelFont, "データベース", 1, 0 scale <16.0, 16.0, 2> texture { LabelTecture }
 translate <510.67, -417.98, 30.00> }
...
<257.33, -269.98, 4.00>, 3.0
<546.67, -269.65, 4.00>, 3.0
  texture { AssociationTexture }}

sphere_sweep { linear_spline, 2, 
<106.67, -270.15, 4.00>, 3.0
<257.33, -269.98, 4.00>, 3.0
  texture { AssociationTexture }}

sphere_sweep { linear_spline, 2, 
<546.67, -269.65, 4.00>, 3.0
<546.67, -381.98, 4.00>, 3.0
  texture { AssociationTexture }}

}
object { UseCaseDiagram_96s_b27d36a5e0eff1055d1b4badf910384a }
#declare EYE = <426.17, -209.22, -667.39>;
#declare FOCUS = <426.17, -209.22, 0.00>;
