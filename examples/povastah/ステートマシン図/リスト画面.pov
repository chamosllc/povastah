...
#local State0_3 = <241.667, -213.487, 0.0>;
#local FinalState0_4 = <243.333, -335.333, 0.0>;
...
#local InitialPseudostate0_11 = <164.667, -196.000, 0.0>;
#local State0_12 = <233.235, -227.154, 0.0>;
#local FinalState0_13 = <306.667, -245.333, 0.0>;
...
#declare StateMachineDiagram_e7881a9fa389742b575ef0aabbe66a5249 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate State0_1 }
    object { Circle_Text(LabelFont, "find",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State0_1, 30.0)  }
    torus { LOOPRd, LRd translate vert(<232.569, -89.154, 0.000>, - LOOPRd) material { TransitionMaterial } no_shadow }
  difference {
    sphere_sweep { cubic_spline, 5,  vert(State0_1, 4.0), LRd  vert(State0_1, 4.0), LRd  vertex(State0_1, <67.431, 33.820, 4.000>), LRd  vert(State0_2, 4.0), LRd  vert(State0_2, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State0_2, -4.0) }
    no_shadow }
  difference {    sphere_sweep { cubic_spline, 5,  vert(State0_1, 4.0), LRd  vert(State0_1, 4.0), LRd/1.0  vertex(State0_1, <67.431, 33.820, 4.000>), LRd/2.0  vert(State0_2, 4.0), LRd/4.0  vert(State0_2, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State0_2, -4.0) }
    no_image }
  difference {
  ...
  difference {
    sphere_sweep { linear_spline, 2,  vert(State0_2, 4.0), LRd  vert(State0_3, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State0_2, -4.0) }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State0_3, -4.0) }
    no_shadow }
  difference {    sphere_sweep { linear_spline, 2,  vert(State0_2, 4.0), LRd  vert(State0_3, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State0_2, -4.0) }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State0_3, -4.0) }
    no_image }
  difference {
    sphere_sweep { linear_spline, 2,  vert(State0_2, 4.0), LRd  vert(State0_1, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State0_2, -4.0) }
    no_shadow }
  difference {    sphere_sweep { linear_spline, 2,  vert(State0_2, 4.0), LRd  vert(State0_1, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State0_2, -4.0) }
    no_image }
  difference {
    object { StateInternal scale<203.333, 130.974, 20.00> translate vert(State0_3, -4.0)  }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vertex(State0_3, <0.000, 0.000, -4.500>) }
  }
    text { ttf LabelFont, "select", 1, 0 scale TextScale texture { LabelTecture } translate vertex(State0_3, <-77.667, 41.487, 0.000>) no_shadow }

  difference {
    sphere_sweep { linear_spline, 2,  vert(State0_3, 4.0), LRd  vert(FinalState0_4, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State0_3, -4.0) }
    no_shadow }
  difference {    sphere_sweep { linear_spline, 2,  vert(State0_3, 4.0), LRd  vert(FinalState0_4, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State0_3, -4.0) }
    no_image }
  ...
  object { State rotate -x*90 scale 24.0 translate State0_6 }
    object { Circle_Text(LabelFont, "entity",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State0_6, 30.0)  }
    union{
  ...
  object { State rotate -x*90 scale 24.0 translate State0_8 }
    object { Circle_Text(LabelFont, "type",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State0_8, 30.0)  }
    union{
  ...
  object { InitialPseudostate rotate -x*90 scale 24.0 translate InitialPseudostate0_11 }
    union{
    sphere_sweep { linear_spline, 2,  vert(InitialPseudostate0_11, 4.0), LRd  vert(State0_12, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { linear_spline, 2,  vert(InitialPseudostate0_11, 4.0), LRd  vert(State0_12, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate State0_12 }
    object { Circle_Text(LabelFont, "do",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State0_12, 30.0)  }
    union{
    sphere_sweep { linear_spline, 2,  vert(State0_12, 4.0), LRd  vert(FinalState0_13, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { linear_spline, 2,  vert(State0_12, 4.0), LRd  vert(FinalState0_13, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { FinalState rotate -x*90 scale 24.0 translate FinalState0_13 }
}
