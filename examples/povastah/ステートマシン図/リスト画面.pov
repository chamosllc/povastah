...
#local JoinPseudostate0_15 = <247.667, -309.833, 0.0>;
  ...
  difference {
    sphere_sweep { cubic_spline, 6,  vert(State0_8, 4.0), LRd  vert(State0_8, 4.0), LRd  vert(vertex(State0_8, <-51.618, -33.090, 4.000>), -28.0), LRd  vertex(State0_8, <-103.235, -66.180, 4.000>), LRd  vert(State0_3, 4.0), LRd  vert(State0_3, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<220.513, 156.443, 20.00> translate vert(State0_3, -4.0) }
    no_shadow }
  difference {    sphere_sweep { cubic_spline, 6,  vert(State0_8, 4.0), LRd  vert(State0_8, 4.0), LRd/1.0  vert(vertex(State0_8, <-51.618, -33.090, 4.000>), -28.0), LRd/2.0  vertex(State0_8, <-103.235, -66.180, 4.000>), LRd/4.0  vert(State0_3, 4.0), LRd/8.0  vert(State0_3, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<220.513, 156.443, 20.00> translate vert(State0_3, -4.0) }
    no_image }
  ...
  object { State rotate -x*90 scale 24.0 translate State0_11 }
    ...
    union{
    sphere_sweep { cubic_spline, 5,  vert(State0_11, 4.0), LRd  vert(State0_11, 4.0), LRd  vert(vertex(State0_11, <-35.451, -23.007, 4.000>), -28.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(State0_11, 4.0), LRd  vert(State0_11, 4.0), LRd/1.0  vert(vertex(State0_11, <-35.451, -23.007, 4.000>), -28.0), LRd/2.0  vert(JoinPseudostate0_15, 4.0), LRd/4.0  vert(JoinPseudostate0_15, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate State0_12 }
    ...
    union{
    sphere_sweep { cubic_spline, 5,  vert(State0_12, 4.0), LRd  vert(State0_12, 4.0), LRd  vert(vertex(State0_12, <35.882, -23.007, 4.000>), -28.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(State0_12, 4.0), LRd  vert(State0_12, 4.0), LRd/1.0  vert(vertex(State0_12, <35.882, -23.007, 4.000>), -28.0), LRd/2.0  vert(JoinPseudostate0_15, 4.0), LRd/4.0  vert(JoinPseudostate0_15, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { ChoicePseudostate rotate -x*90 scale 24.0 translate ChoicePseudostate0_13 }
    union{
    sphere_sweep { cubic_spline, 5,  vert(ChoicePseudostate0_13, 4.0), LRd  vert(ChoicePseudostate0_13, 4.0), LRd  vert(vertex(ChoicePseudostate0_13, <-37.500, -52.917, 4.000>), -28.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(ChoicePseudostate0_13, 4.0), LRd  vert(ChoicePseudostate0_13, 4.0), LRd/1.0  vert(vertex(ChoicePseudostate0_13, <-37.500, -52.917, 4.000>), -28.0), LRd/2.0  vert(ForkPseudostate0_14, 4.0), LRd/4.0  vert(ForkPseudostate0_14, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  difference {
  ...
  object { ForkPseudostate rotate -x*90 scale 24.0 translate ForkPseudostate0_14 }
    union{
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd  vert(vertex(ForkPseudostate0_14, <-33.882, -18.660, 4.000>), -28.0), LRd  vert(State0_12, 4.0), LRd  vert(State0_12, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd/1.0  vert(vertex(ForkPseudostate0_14, <-33.882, -18.660, 4.000>), -28.0), LRd/2.0  vert(State0_12, 4.0), LRd/4.0  vert(State0_12, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
    union{
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd  vert(vertex(ForkPseudostate0_14, <37.451, -18.660, 4.000>), -28.0), LRd  vert(State0_11, 4.0), LRd  vert(State0_11, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd/1.0  vert(vertex(ForkPseudostate0_14, <37.451, -18.660, 4.000>), -28.0), LRd/2.0  vert(State0_11, 4.0), LRd/4.0  vert(State0_11, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { JoinPseudostate rotate -x*90 scale 24.0 translate JoinPseudostate0_15 }
    union{
    sphere_sweep { cubic_spline, 5,  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd  vert(vertex(JoinPseudostate0_15, <109.167, -7.083, 4.000>), -28.0), LRd  vert(FinalState0_4, 4.0), LRd  vert(FinalState0_4, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd/1.0  vert(vertex(JoinPseudostate0_15, <109.167, -7.083, 4.000>), -28.0), LRd/2.0  vert(FinalState0_4, 4.0), LRd/4.0  vert(FinalState0_4, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
}
