...
#local JoinPseudostate0_15 = <247.667, -309.833, 0.0>;
  ...
  difference {
    sphere_sweep { cubic_spline, 6,  vert(State0_8, 4.0), LRd  vert(State0_8, 4.0), LRd  vert(vertex(State0_8, <-51.618, -33.090, 4.000>), -32.0), LRd  vertex(State0_3, <193.000, 21.667, 4.000>), LRd  vert(State0_3, 4.0), LRd  vert(State0_3, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<220.513, 156.443, 20.00> translate vert(State0_3, -4.0) }
    no_shadow }
  difference {    sphere_sweep { cubic_spline, 6,  vert(State0_8, 4.0), LRd  vert(State0_8, 4.0), LRd/1.0  vert(vertex(State0_8, <-51.618, -33.090, 4.000>), -32.0), LRd/2.0  vertex(State0_3, <193.000, 21.667, 4.000>), LRd/4.0  vert(State0_3, 4.0), LRd/8.0  vert(State0_3, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<220.513, 156.443, 20.00> translate vert(State0_3, -4.0) }
    no_image }
  ...
  object { State rotate -x*90 scale 24.0 translate State0_11 }
    ...
    union{
    sphere_sweep { cubic_spline, 5,  vert(State0_11, 4.0), LRd  vert(State0_11, 4.0), LRd  vert(vertexCenter(State0_11, JoinPseudostate0_15), RAISE/4 + 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(State0_11, 4.0), LRd  vert(State0_11, 4.0), LRd/1.0  vert(vertexCenter(State0_11, JoinPseudostate0_15), RAISE/4 + 4.0), LRd/2.0  vert(JoinPseudostate0_15, 4.0), LRd/4.0  vert(JoinPseudostate0_15, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate State0_12 }
    ...
    union{
    sphere_sweep { cubic_spline, 5,  vert(State0_12, 4.0), LRd  vert(State0_12, 4.0), LRd  vert(vertexCenter(State0_12, JoinPseudostate0_15), RAISE/4 + 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(State0_12, 4.0), LRd  vert(State0_12, 4.0), LRd/1.0  vert(vertexCenter(State0_12, JoinPseudostate0_15), RAISE/4 + 4.0), LRd/2.0  vert(JoinPseudostate0_15, 4.0), LRd/4.0  vert(JoinPseudostate0_15, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { ChoicePseudostate rotate -x*90 scale 24.0 translate ChoicePseudostate0_13 }
    union{
    sphere_sweep { cubic_spline, 5,  vert(ChoicePseudostate0_13, 4.0), LRd  vert(ChoicePseudostate0_13, 4.0), LRd  vertCenter(ForkPseudostate0_14, ChoicePseudostate0_13, -32.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(ChoicePseudostate0_13, 4.0), LRd  vert(ChoicePseudostate0_13, 4.0), LRd/1.0  vertCenter(ForkPseudostate0_14, ChoicePseudostate0_13, -32.0), LRd/2.0  vert(ForkPseudostate0_14, 4.0), LRd/4.0  vert(ForkPseudostate0_14, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  difference {
  ...
  object { ForkPseudostate rotate -x*90 scale 24.0 translate ForkPseudostate0_14 }
    union{
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd  vert(vertexCenter(ForkPseudostate0_14, State0_12), RAISE/4 + 4.0), LRd  vert(State0_12, 4.0), LRd  vert(State0_12, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd/1.0  vert(vertexCenter(ForkPseudostate0_14, State0_12), RAISE/4 + 4.0), LRd/2.0  vert(State0_12, 4.0), LRd/4.0  vert(State0_12, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
    union{
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd  vert(vertexCenter(ForkPseudostate0_14, State0_11), RAISE/4 + 4.0), LRd  vert(State0_11, 4.0), LRd  vert(State0_11, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(ForkPseudostate0_14, 4.0), LRd  vert(ForkPseudostate0_14, 4.0), LRd/1.0  vert(vertexCenter(ForkPseudostate0_14, State0_11), RAISE/4 + 4.0), LRd/2.0  vert(State0_11, 4.0), LRd/4.0  vert(State0_11, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { JoinPseudostate rotate -x*90 scale 24.0 translate JoinPseudostate0_15 }
    union{
    sphere_sweep { cubic_spline, 5,  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd  vertCenter(JoinPseudostate0_15, FinalState0_4, -32.0), LRd  vert(FinalState0_4, 4.0), LRd  vert(FinalState0_4, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5,  vert(JoinPseudostate0_15, 4.0), LRd  vert(JoinPseudostate0_15, 4.0), LRd/1.0  vertCenter(JoinPseudostate0_15, FinalState0_4, -32.0), LRd/2.0  vert(FinalState0_4, 4.0), LRd/4.0  vert(FinalState0_4, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
}
