...
#declare StateMachineDiagram_e7881a9fa389742b575ef0aabbe66a5249 = union {
  ...
  difference {
    sphere_sweep { cubic_spline, 5, <232.569, -89.154, 4.00>, LRd <232.569, -89.154, 4.00>, LRd <300.000, -55.333, 4.00>, LRd <540.000, -115.846, 4.00>, LRd <540.000, -115.846, 4.00>, LRd material { TransitionMaterial }  }
  ...
  difference {
    sphere_sweep { linear_spline, 2, <540.000, -115.846, 4.00>, LRd <241.667, -213.487, 4.00>, LRd material { TransitionMaterial }  }
    object { StateInternal scale<246.960, 176.701, 20.00> translate <540.000, -115.846, 0.00> }
  ...
  difference {    sphere_sweep { linear_spline, 2, <540.000, -115.846, 4.00>, LRd <241.667, -213.487, 4.00>, 0.0 material { ShadowTransitionMaterial }  }
    ...
    no_image }
  difference {
    sphere_sweep { linear_spline, 2, <540.000, -115.846, 4.00>, LRd <232.569, -89.154, 4.00>, LRd material { TransitionMaterial }  }
    object { StateInternal scale<246.960, 176.701, 20.00> translate <540.000, -115.846, 0.00> }
    no_shadow }
  ...
  difference {
    sphere_sweep { linear_spline, 2, <241.667, -213.487, 4.00>, LRd <243.333, -335.333, 4.00>, LRd material { TransitionMaterial }  }
    object { StateInternal scale<199.267, 128.354, 20.00> translate <241.667, -213.487, 0.00> }
    no_shadow }
...
#declare StateMachineDiagram_bffke8128ac6c1d56428bfcbc5567f70b355 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate <584.569, -72.180, 0.00> }
    ...
    union{
    sphere_sweep { cubic_spline, 5, <584.569, -72.180, 4.00>, LRd <584.569, -72.180, 4.00>, LRd <376.284, -101.423, -32.00>, LRd <168.000, -130.667, 4.00>, LRd <168.000, -130.667, 4.00>, LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 5, <584.569, -72.180, 4.00>, LRd <584.569, -72.180, 4.00>, LRd <376.284, -101.423, -32.00>, LRd/2.0 <168.000, -130.667, 4.00>, 0.0 <168.000, -130.667, 4.00>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
    union{
...
#declare StateMachineDiagram_1u2y6174cfd7c659288bc9badb700978b1e1 = union {
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <169.111, -133.807, 0.00> }
    ...
    sphere_sweep { linear_spline, 2, <169.111, -133.807, 4.00>, LRd <298.873, -133.807, 4.00>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate <298.873, -133.807, 0.00> }
    ...
    sphere_sweep { linear_spline, 2, <298.873, -133.807, 4.00>, LRd <538.144, -133.807, 4.00>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
