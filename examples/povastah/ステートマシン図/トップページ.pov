...
// StateMachineDiagram_1u2y6174cfd7c659288bc9badb700978b1e1
...
#local State2_3 = <241.667, -213.487, 0.0>;
#local FinalState2_4 = <243.333, -335.333, 0.0>;
...
#local InitialPseudostate2_11 = <164.667, -196.000, 0.0>;
#local State2_12 = <233.235, -227.154, 0.0>;
#local FinalState2_13 = <306.667, -245.333, 0.0>;
...
#declare StateMachineDiagram_e7881a9fa389742b575ef0aabbe66a5249 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate State2_1 }
    object { Circle_Text(LabelFont, "find",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State2_1, 30.0)  }
    torus { LOOPRd, LRd translate vert(<232.569, -89.154, 0.000>, - LOOPRd) material { TransitionMaterial } no_shadow }
  difference {
    sphere_sweep { cubic_spline, 5,  vert(State2_1, 4.0), LRd  vert(State2_1, 4.0), LRd  vertex(State2_1, <67.431, 33.820, 4.000>), LRd  vert(State2_2, 4.0), LRd  vert(State2_2, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State2_2, -4.0) }
    no_shadow }
  difference {    sphere_sweep { cubic_spline, 5,  vert(State2_1, 4.0), LRd  vert(State2_1, 4.0), LRd/1.0  vertex(State2_1, <67.431, 33.820, 4.000>), LRd/2.0  vert(State2_2, 4.0), LRd/4.0  vert(State2_2, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State2_2, -4.0) }
    no_image }
  difference {
  ...
  difference {
    sphere_sweep { linear_spline, 2,  vert(State2_2, 4.0), LRd  vert(State2_3, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State2_2, -4.0) }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State2_3, -4.0) }
    no_shadow }
  difference {    sphere_sweep { linear_spline, 2,  vert(State2_2, 4.0), LRd  vert(State2_3, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State2_2, -4.0) }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State2_3, -4.0) }
    no_image }
  difference {
    sphere_sweep { linear_spline, 2,  vert(State2_2, 4.0), LRd  vert(State2_1, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State2_2, -4.0) }
    no_shadow }
  difference {    sphere_sweep { linear_spline, 2,  vert(State2_2, 4.0), LRd  vert(State2_1, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<244.440, 174.898, 20.00> translate vert(State2_2, -4.0) }
    no_image }
  difference {
    object { StateInternal scale<203.333, 130.974, 20.00> translate vert(State2_3, -4.0)  }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vertex(State2_3, <0.000, 0.000, -4.500>) }
  }
    text { ttf LabelFont, "select", 1, 0 scale TextScale texture { LabelTecture } translate vertex(State2_3, <-77.667, 41.487, 0.000>) no_shadow }

  difference {
    sphere_sweep { linear_spline, 2,  vert(State2_3, 4.0), LRd  vert(FinalState2_4, 4.0), LRd material { TransitionMaterial }  }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State2_3, -4.0) }
    no_shadow }
  difference {    sphere_sweep { linear_spline, 2,  vert(State2_3, 4.0), LRd  vert(FinalState2_4, 4.0), 0.0 material { ShadowTransitionMaterial }  }
    object { StateInternal scale<197.233, 127.045, 20.00> translate vert(State2_3, -4.0) }
    no_image }
  ...
  object { State rotate -x*90 scale 24.0 translate State2_6 }
    object { Circle_Text(LabelFont, "entity",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State2_6, 30.0)  }
    union{
  ...
  object { State rotate -x*90 scale 24.0 translate State2_8 }
    object { Circle_Text(LabelFont, "type",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State2_8, 30.0)  }
    union{
  ...
  object { InitialPseudostate rotate -x*90 scale 24.0 translate InitialPseudostate2_11 }
    union{
    sphere_sweep { linear_spline, 2,  vert(InitialPseudostate2_11, 4.0), LRd  vert(State2_12, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { linear_spline, 2,  vert(InitialPseudostate2_11, 4.0), LRd  vert(State2_12, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate State2_12 }
    object { Circle_Text(LabelFont, "do",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State2_12, 30.0)  }
    union{
    sphere_sweep { linear_spline, 2,  vert(State2_12, 4.0), LRd  vert(FinalState2_13, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { linear_spline, 2,  vert(State2_12, 4.0), LRd  vert(FinalState2_13, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { FinalState rotate -x*90 scale 24.0 translate FinalState2_13 }
}
#declare StateMachineDiagram_bffke8128ac6c1d56428bfcbc5567f70b355 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate State1_1 }
    object { Circle_Text(LabelFont, "show entity",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State1_1, 30.0)  }
  difference {
  ...
  object { StateMachineDiagram_e7881a9fa389742b575ef0aabbe66a5249 scale 0.18853109137055837  translate vertex(SubmachineState1_4, <-78.617, 29.919, -5.844>) }
  ...
  object { State rotate -x*90 scale 24.0 translate State1_6 }
    object { Circle_Text(LabelFont, "edit",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State1_6, 30.0)  }
    union{
  ...
  object { State rotate -x*90 scale 24.0 translate State1_7 }
    object { Circle_Text(LabelFont, "change",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State1_7, 30.0)  }
    union{
    sphere_sweep { cubic_spline, 6,  vert(State1_7, 4.0), LRd  vert(State1_7, 4.0), LRd  vert(vertex(State1_7, <-104.142, -14.622, 4.000>), -28.0), LRd  vertex(State1_7, <-208.284, -29.243, 4.000>), LRd  vert(ChoicePseudostate1_3, 4.0), LRd  vert(ChoicePseudostate1_3, 4.0), LRd material { TransitionMaterial } no_shadow }
    sphere_sweep { cubic_spline, 6,  vert(State1_7, 4.0), LRd  vert(State1_7, 4.0), LRd/1.0  vert(vertex(State1_7, <-104.142, -14.622, 4.000>), -28.0), LRd/2.0  vertex(State1_7, <-208.284, -29.243, 4.000>), LRd/4.0  vert(ChoicePseudostate1_3, 4.0), LRd/8.0  vert(ChoicePseudostate1_3, 4.0), 0.0 material { ShadowTransitionMaterial } no_image }
    }
    union{
...
#declare StateMachineDiagram_1u2y6174cfd7c659288bc9badb700978b1e1 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate State0_1 }
    object { Circle_Text(LabelFont, "受付",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(State0_1, 30.0)  }
    union{
