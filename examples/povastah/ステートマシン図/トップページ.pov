...
#declare StateMachineDiagram_e7881a9fa389742b575ef0aabbe66a5249 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate <232.569, -89.154, 0.00> }
    ...
    torus { LOOPRd, LRd translate<232.56875813802083, -89.15364583333333, 4.0 - LOOPRd> material { TransitionMaterial }  }
...
#declare StateMachineDiagram_bffke8128ac6c1d56428bfcbc5567f70b355 = union {
  ...
  difference {    sphere_sweep { linear_spline, 2, <218.758, -13.820, 4.00>, LRd <519.738, -41.359, 4.00>, LRd material { TransitionMaterial } }
    object { StateInternal scale<245.857, 154.000, 16.00> translate <519.738, -41.359, 0.00> }
 no_shadow }
  difference {    sphere_sweep { linear_spline, 2, <218.758, -13.820, 4.00>, LRd <519.738, -41.359, 4.00>, 0.0 material { ShadowTransitionMaterial } }
    object { StateInternal scale<245.857, 154.000, 16.00> translate <519.738, -41.359, 0.00> }
 no_image }
    torus { LOOPRd, LRd translate<218.7576350911458, -13.820312499999993, 4.0 - LOOPRd> material { TransitionMaterial }  }
    union{
  ...
  difference {    object { StateInternal scale<245.857, 154.000, 16.00> translate <519.738, -41.359, 12.00> }
    object { StateInternal scale<233.564, 146.300, 12.00> translate <519.738, -41.359, 0.00> }
  }
...
#declare StateMachineDiagram_1u2y6174cfd7c659288bc9badb700978b1e1 = union {
  ...
  object { SubmachineState scale <175.622, 74.281, 16.00> translate <538.144, -133.807, 0.00> }
