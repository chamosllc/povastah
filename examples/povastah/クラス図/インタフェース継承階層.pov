...
#local Interface0_1 = <221.484, -174.266, -32.0>;
#local Entity0_2 = <477.622, -257.818, 0.0>;
#local Interface0_3 = <221.484, 86.680, -128.0>;
#local Interface0_4 = <221.484, 1.346, -96.0>;
#local Interface0_5 = <221.484, -86.654, -64.0>;
...
// Generalization
    sphere_sweep { linear_spline, 2, Boundary0_0, LRd Interface0_1, LRd material { GeneralizationMaterial } no_shadow }
  object { Interface rotate -x*90 scale 24.0 translate Interface0_1 }
    object { Circle_Text(LabelFont, "JpaRepository",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Interface0_1, 62.0)  no_shadow }
// Generalization
    sphere_sweep { linear_spline, 2, Interface0_1, LRd Interface0_5, LRd material { GeneralizationMaterial } no_shadow }
  ...
  object { Interface rotate -x*90 scale 24.0 translate Interface0_3 }
    object { Circle_Text(LabelFont, "Repository",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Interface0_3, 158.0)  no_shadow }
  object { Interface rotate -x*90 scale 24.0 translate Interface0_4 }
    object { Circle_Text(LabelFont, "PagingAndSortingRepository",  0.800, 0, 2, 1.800, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Interface0_4, 126.0)  no_shadow }
// Generalization
    sphere_sweep { linear_spline, 2, Interface0_4, LRd Interface0_3, LRd material { GeneralizationMaterial } no_shadow }
  object { Interface rotate -x*90 scale 24.0 translate Interface0_5 }
    object { Circle_Text(LabelFont, "CrudRepository",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Interface0_5, 94.0)  no_shadow }
// Generalization
    sphere_sweep { linear_spline, 2, Interface0_5, LRd Interface0_4, LRd material { GeneralizationMaterial } no_shadow }
}
