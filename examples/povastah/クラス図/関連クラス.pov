...
// ClassDiagram_1ppa6174cfd7c659288bc9badb700978b1e1
...
#declare ClassDiagram_1ppa6174cfd7c659288bc9badb700978b1e1 = union {
  object { Entity rotate -x*90 scale 24.0 translate Entity0_0 }
    object { Circle_Text(LabelFont, "Entity",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Entity0_0, 30.0)  }
// AssociationClass
  ...
  object { Class rotate -x*90 scale 24.0 translate Class0_1 }
    object { Circle_Text(LabelFont, "Domain",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Class0_1, 30.0)  }
  object { AssociationClass rotate -x*90 scale 24.0 translate AssociationClass0_2 }
    object { Circle_Text(LabelFont, "Context",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(AssociationClass0_2, 30.0)  }
}
