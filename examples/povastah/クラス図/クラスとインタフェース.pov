...
// ClassDiagram_zm36174cfd7c659288bc9badb700978b1e1
...
#declare ClassDiagram_zm36174cfd7c659288bc9badb700978b1e1 = union {
  object { Interface rotate -x*90 scale 24.0 translate Interface0_0 }
    object { Circle_Text(LabelFont, "Serializable",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Interface0_0, 30.0)  }
// Realization
    union{
