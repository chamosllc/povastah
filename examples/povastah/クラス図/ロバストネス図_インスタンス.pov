...
// ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a
...
#declare ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a = union {
  object { Boundary rotate -x*90 scale 24.0 translate Boundary0_0 }
    object { Circle_Text(LabelFont, "EntityRepository",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Boundary0_0, 30.0)  }
// Association
    union{
  ...
  object { Control rotate -x*90 scale 24.0 translate Control0_1 }
    object { Circle_Text(LabelFont, "EntityController",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Control0_1, 30.0)  }
// Association
    union{
  ...
  object { ControlInstance rotate -x*90 scale 24.0 translate ControlInstance0_3 }
    object { Circle_Text(LabelFont, ":EntityController",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(ControlInstance0_3, 30.0)  }
// Link
  ...
  object { BoundaryInstance rotate -x*90 scale 24.0 translate BoundaryInstance0_4 }
    object { Circle_Text(LabelFont, ":EntityRepository",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(BoundaryInstance0_4, 30.0)  }
// Link
  ...
  object { EntityInstance rotate -x*90 scale 24.0 translate EntityInstance0_5 }
    object { Circle_Text(LabelFont, ":Entity",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(EntityInstance0_5, 30.0)  }
}
object { ClassDiagram_bj3d6ceec00a507a2b70caaa0df577508a }
#declare EYE = <200, -480, -400>;
