...
#declare CommunicationDiagram_aye91724ef1f5857cbf37de84b739c5e16 = union {
  object { ControlInstance rotate -x*90 scale 24.0 translate <332.929, -122.807, 0.00> }
    ...
    sphere_sweep { cubic_spline, 3, <332.929, -122.807, 4.00>, LRd <245.333, -169.333, 0.00>, LRd <210.929, -268.807, 4.00>, LRd material { LifelineLinkMaterial } no_shadow }
  ...
  object { BoundaryInstance rotate -x*90 scale 24.0 translate <452.262, -268.807, 0.00> }
    ...
    sphere_sweep { cubic_spline, 3, <332.929, -122.807, 4.00>, LRd/0.25 <245.333, -169.333, 0.00>, LRd/0.5 <210.929, -268.807, 4.00>, LRd/1.0 material { ShadowLifelineLinkMaterial } no_image }
