...
// hierachy depth: {PagingAndSortingRepository=4, CrudRepository=3, JpaRepository=2, Repository=5, EntityRepository=1}
// #declare Depth = -32.0;
...
#declare ClassDiagram_1muq6174cfd7c659288bc9badb700978b1e1 = union {
  object { Boundary rotate -x*90 scale 24.0 translate <221.484, -257.818, -32.00> }
    ...
    sphere_sweep { linear_spline, 2, <221.484, -257.818, -28.00>, LRd/0.25 <477.622, -257.818, 4.00>, LRd/0.5 material { ShadowAssociationMaterial } no_image }
    }
