...
#local Message0_3 = <246.266, -178.534, 0.0>;
  ...
  object { ControlInstance rotate -x*90 scale 24.0 translate ControlInstance0_0 }
    object { Circle_Text(LabelFont, " : EntityController",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(ControlInstance0_0, 30.0)  no_shadow }
  ...
  object { EntityInstance rotate -x*90 scale 24.0 translate EntityInstance0_1 }
    object { Circle_Text(LabelFont, " : Entity",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(EntityInstance0_1, 30.0)  no_shadow }
  object { BoundaryInstance rotate -x*90 scale 24.0 translate BoundaryInstance0_2 }
    object { Circle_Text(LabelFont, " : EntityRepository",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(BoundaryInstance0_2, 30.0)  no_shadow }
