...
// UseCaseDiagram_3rj6174cfd7c659288bc9badb700978b1e1
...
#declare UseCaseDiagram_3rj6174cfd7c659288bc9badb700978b1e1 = union {
  ...
  object { Actor rotate -x*90 scale 24.0 translate Actor0_1 }
    object { Circle_Text(LabelFont, "アクター",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale TextScale texture { LabelTecture } translate vert(Actor0_1, 30.0)  }
// Association
    union{
