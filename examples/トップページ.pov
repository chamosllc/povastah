...
#declare StateMachineDiagram_bffke8128ac6c1d56428bfcbc5567f70b355 = union {
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <88.667, -132.667, 0.000> }
    object { Circle_Text( LabelFont, " ",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <88.667, -132.667, 30.000> }
  ...
  object { ChoicePseudostate rotate -x*90 scale 24.0 translate <168.000, -130.667, 0.000> }
    object { Circle_Text( LabelFont, " ",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <168.000, -130.667, 30.000> }
  ...
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <422.667, -27.693, 0.000> }
    object { Circle_Text( LabelFont, " ",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <422.667, -27.693, 30.000> }
...
#declare StateMachineDiagram_1u2y6174cfd7c659288bc9badb700978b1e1 = union {
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <169.111, -133.807, 0.000> }
    object { Circle_Text( LabelFont, " ",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <169.111, -133.807, 30.000> }
  ...
  object { SubmachineState scale <175.622, 74.281, 16.000> translate <538.144, -133.807, 0.000> }
    ...
    sphere_sweep { linear_spline, 2, <298.873, -133.807, 4.000>, 3.0 <538.144, -133.807, 4.000>, 3.0 texture { TransitionTexture }}
    sphere_sweep { linear_spline, 2, <169.111, -133.807, 4.000>, 3.0 <298.873, -133.807, 4.000>, 3.0 texture { TransitionTexture }}
}
