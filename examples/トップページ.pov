...
#declare StateMachineDiagram_bffke8128ac6c1d56428bfcbc5567f70b355 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate <584.569, -72.180, 0.000> }
    ...
    sphere_sweep { linear_spline, 2, <88.667, -132.667, 4.000>, 3.0 <168.000, -130.667, 4.000>, 3.0 material { TransitionMaterial }}
    sphere_sweep { linear_spline, 2, <168.000, -130.667, 4.000>, 3.0 <218.758, -13.820, 4.000>, 3.0 material { TransitionMaterial }}
  difference {
    sphere_sweep { linear_spline, 2, <218.758, -13.820, 4.000>, 3.0 <519.738, -41.359, 4.000>, 3.0 material { TransitionMaterial }}
    object { StateInternal scale<245.857, 154.000, 16.000> translate <519.738, -41.359, 0.000> }
  }
    sphere_sweep { linear_spline, 2, <584.569, -72.180, 4.000>, 3.0 <168.000, -130.667, 4.000>, 3.0 material { TransitionMaterial }}
  torus { 36.0, 3.0 translate <218.758, -13.820, -32.000>material { TransitionMaterial }}
    sphere_sweep { cubic_spline, 5, <218.758, -13.820, 4.000>, 3.0 <218.758, -13.820, 4.000>, 3.0 <159.333, -56.333, 4.000>, 3.0 <168.000, -130.667, 4.000>, 3.0 <168.000, -130.667, 4.000>, 3.0 material { TransitionMaterial }}
    sphere_sweep { linear_spline, 2, <412.019, -192.180, 4.000>, 3.0 <168.000, -130.667, 4.000>, 3.0 material { TransitionMaterial }}
    sphere_sweep { cubic_spline, 5, <168.000, -130.667, 4.000>, 3.0 <168.000, -130.667, 4.000>, 3.0 <258.667, -185.000, 4.000>, 3.0 <412.019, -192.180, 4.000>, 3.0 <412.019, -192.180, 4.000>, 3.0 material { TransitionMaterial }}
    sphere_sweep { linear_spline, 2, <422.667, -27.693, 4.000>, 3.0 <495.235, -28.180, 4.000>, 3.0 material { TransitionMaterial }}
    sphere_sweep { cubic_spline, 5, <495.235, -28.180, 4.000>, 3.0 <495.235, -28.180, 4.000>, 3.0 <561.333, -31.026, 4.000>, 3.0 <584.569, -72.180, 4.000>, 3.0 <584.569, -72.180, 4.000>, 3.0 material { TransitionMaterial }}
    sphere_sweep { cubic_spline, 5, <584.569, -72.180, 4.000>, 3.0 <584.569, -72.180, 4.000>, 3.0 <494.000, -63.693, 4.000>, 3.0 <495.235, -28.180, 4.000>, 3.0 <495.235, -28.180, 4.000>, 3.0 material { TransitionMaterial }}
}
#declare StateMachineDiagram_1u2y6174cfd7c659288bc9badb700978b1e1 = union {
  ...
  object { State rotate -x*90 scale 24.0 translate <298.873, -133.807, 0.000> }
    object { Circle_Text( LabelFont, "受付",  1.000, 0, 2, 1.600, 1, Align_Center, -90) scale <16, 16, 2> texture { LabelTecture } translate <298.873, -133.807, 30.000> }
  ...
  object { SubmachineState scale <175.622, 74.281, 16.000> translate <538.144, -133.807, 0.000> }
    text { ttf LabelFont, "Entity", 1, 0 scale <16, 16, 2> texture { LabelTecture } translate <462.333, -112.667, -0.010> }
    sphere_sweep { linear_spline, 2, <298.873, -133.807, 4.000>, 3.0 <538.144, -133.807, 4.000>, 3.0 material { TransitionMaterial }}
    sphere_sweep { linear_spline, 2, <169.111, -133.807, 4.000>, 3.0 <298.873, -133.807, 4.000>, 3.0 material { TransitionMaterial }}
}
