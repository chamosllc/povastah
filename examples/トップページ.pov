...
#declare StateMachineDiagram_bffke8128ac6c1d56428bfcbc5567f70b355 = union {
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <88.667, -132.667, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <88.667, -132.667, 4.0>, LRd <168.000, -130.667, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
 ...
 no_shadow }
  difference {    sphere_sweep { linear_spline, 2, <218.758, -13.820, 4.0>, LRd <519.738, -41.359, 4.0>, 0.0 material { ShadowTransitionMaterial } }
    object { StateInternal scale<245.857, 154.000, 16.0> translate <519.738, -41.359, 0.0> }
 no_image }
    ...
    sphere_sweep { cubic_spline, 5, <218.758, -13.820, 4.0>, LRd <218.758, -13.820, 4.0>, LRd <159.333, -56.333, 4.0>, LRd/2.0 <168.000, -130.667, 4.0>, 0.0 <168.000, -130.667, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
  ...
  object { ChoicePseudostate rotate -x*90 scale 24.0 translate <168.000, -130.667, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <168.000, -130.667, 4.0>, LRd <218.758, -13.820, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
    union{
    ...
    sphere_sweep { cubic_spline, 5, <168.000, -130.667, 4.0>, LRd <168.000, -130.667, 4.0>, LRd <258.667, -185.000, 4.0>, LRd/2.0 <412.019, -192.180, 4.0>, 0.0 <412.019, -192.180, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
  ...
  object { SubmachineState scale <183.664, 74.281, 16.0> translate <412.019, -192.180, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <412.019, -192.180, 4.0>, LRd <168.000, -130.667, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <422.667, -27.693, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <422.667, -27.693, 4.0>, LRd <495.235, -28.180, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate <495.235, -28.180, 0.0> }
    ...
    sphere_sweep { cubic_spline, 5, <495.235, -28.180, 4.0>, LRd <495.235, -28.180, 4.0>, LRd <561.333, -31.026, 4.0>, LRd/2.0 <584.569, -72.180, 4.0>, 0.0 <584.569, -72.180, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate <584.569, -72.180, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <584.569, -72.180, 4.0>, LRd <168.000, -130.667, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
    union{
    ...
    sphere_sweep { cubic_spline, 5, <584.569, -72.180, 4.0>, LRd <584.569, -72.180, 4.0>, LRd <494.000, -63.693, 4.0>, LRd/2.0 <495.235, -28.180, 4.0>, 0.0 <495.235, -28.180, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
}
#declare StateMachineDiagram_1u2y6174cfd7c659288bc9badb700978b1e1 = union {
  object { InitialPseudostate rotate -x*90 scale 24.0 translate <169.111, -133.807, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <169.111, -133.807, 4.0>, LRd <298.873, -133.807, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
  object { State rotate -x*90 scale 24.0 translate <298.873, -133.807, 0.0> }
    ...
    sphere_sweep { linear_spline, 2, <298.873, -133.807, 4.0>, LRd <538.144, -133.807, 4.0>, 0.0 material { ShadowTransitionMaterial } no_image }
    }
