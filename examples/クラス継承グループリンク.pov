...
#declare ClassDiagram_az488dd3ba7186d4a0d516cbeb00eb6449 = union {
  ...
  object { Class rotate -x*90 scale 24.0 translate <310.833, -239.487, -32.000> }
    ...
    sphere_sweep { linear_spline, 2, <127.500, -239.487, -28.000>, 3.0 <216.167, -82.154, -60.000>, 3.0 material { GeneralizationMaterial }}
    sphere_sweep { linear_spline, 2, <310.833, -239.487, -28.000>, 3.0 <216.167, -82.154, -60.000>, 3.0 material { GeneralizationMaterial }}
}
