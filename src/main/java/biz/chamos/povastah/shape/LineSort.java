...
public enum LineSort {
	 ...
	 *  JumpOut: [始点', 始点', 始点と中間点の中間点↑, 中間点, 終点', 終点']
	 *  JumpIn: [始点', 始点', 中間点, 始点と中間点の中間点↑, 終点', 終点']
	 * リンク軌跡点列=[始点, …, 終点]の場合
	 * 	Both:   [始点', 始点', Pn↑, 終点', 終点']			
	 *  JumpOut: [始点', 始点', P(n<length/2)↑, P(n>=length/2), 終点', 終点']
	 *  JumpIn: [始点', 始点', P(n<length/2), P(n>=length/2)↑, 終点', 終点']
	 *  
	 * @param link
	 * @param source
	 * @param target
